...
public class SmarthomeSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case SmarthomePackage.ON_OFF_TYPE: {
                OnOffType onOffType = (OnOffType)theEObject;
                T result = caseOnOffType(onOffType);
                if (result == null) result = caseState(onOffType);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case SmarthomePackage.OPEN_CLOSED_TYPE: {
                OpenClosedType openClosedType = (OpenClosedType)theEObject;
                T result = caseOpenClosedType(openClosedType);
                if (result == null) result = caseState(openClosedType);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case SmarthomePackage.NEW_ECLASS12: {
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>On Off Type</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>On Off Type</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseOnOffType(OnOffType object) {
        return null;
    }

    /**
     * Returns the result of interpreting the object as an instance of '<em>Open Closed Type</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Open Closed Type</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseOpenClosedType(OpenClosedType object) {
        return null;
    }
