 ...
 * <!-- end-user-doc -->
 * @see smarthome.SmarthomePackage#getOnOff()
 * @model
 * @generated
 */
public enum OnOff implements Enumerator {
    /**
     ...
     * @generated
     */
    private static final OnOff[] VALUES_ARRAY =
        new OnOff[] {
            ON,
            OFF,
        };
     ...
     * @generated
     */
    public static final List<OnOff> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
     ...
     * @generated
     */
    public static OnOff get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            OnOff result = VALUES_ARRAY[i];
     ...
     * @generated
     */
    public static OnOff getByName(String name) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            OnOff result = VALUES_ARRAY[i];
     ...
     * @generated
     */
    public static OnOff get(int value) {
        switch (value) {
     ...
     * @generated
     */
    private OnOff(int value, String name, String literal) {
        this.value = value;
        this.name = name;
