...
public class ContactItemImpl extends MinimalEObjectImpl.Container implements ContactItem {
     ...
     * @ordered
     */
    protected OpenClosedType state;
     ...
     * @generated
     */
    public OpenClosedType getState() {
        return state;
    }
     ...
     * @generated
     */
    public NotificationChain basicSetState(OpenClosedType newState, NotificationChain msgs) {
        OpenClosedType oldState = state;
        state = newState;
        if (eNotificationRequired()) {
     ...
     * @generated
     */
    public void setState(OpenClosedType newState) {
        if (newState != state) {
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            case SmarthomePackage.CONTACT_ITEM__NAME:
                ...
                return;
            case SmarthomePackage.CONTACT_ITEM__STATE:
                setState((OpenClosedType)newValue);
                return;
        }
