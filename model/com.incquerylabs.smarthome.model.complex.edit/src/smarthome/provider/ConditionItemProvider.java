...
public class ConditionItemProvider 
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Condition_connectionType_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Condition_connectionType_feature", "_UI_Condition_type"),
                 SmarthomePackage.Literals.CONDITION__CONNECTION_TYPE,
                 true,
                 false,
                 false,
    ...
    protected void addStatePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Condition_state_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Condition_state_feature", "_UI_Condition_type"),
                 SmarthomePackage.Literals.CONDITION__STATE,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addItemPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Condition_item_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Condition_item_feature", "_UI_Condition_type"),
                 SmarthomePackage.Literals.CONDITION__ITEM,
                 true,
                 false,
                 true,
                 null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(SmarthomePackage.Literals.CONDITION__STATE);
        }
    ...
    public String getText(Object object) {
        ConnectionType labelValue = ((Condition)object).getConnectionType();
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (SmarthomePackage.Literals.CONDITION__STATE,
                 SmarthomeFactory.eINSTANCE.createOnOffType()));

        newChildDescriptors.add
            (createChildParameter
                (SmarthomePackage.Literals.CONDITION__STATE,
                 SmarthomeFactory.eINSTANCE.createOpenClosedType()));
    }
