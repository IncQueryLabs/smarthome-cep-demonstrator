...
public class EvaluatingNodeImpl extends MinimalEObjectImpl.Container implements EvaluatingNode {
	 ...
	 * @ordered
	 */
    protected EList<CommandConnection> commands;
	 ...
	 * @generated
	 */
    public EList<CommandConnection> getCommands() {
		if (commands == null) {
			commands = new EObjectContainmentEList<CommandConnection>(CommandConnection.class, this, SmarthomePackage.EVALUATING_NODE__COMMANDS);
		}
		return commands;
	}
    ...
    public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SmarthomePackage.EVALUATING_NODE__COMMANDS:
				getCommands().clear();
				getCommands().addAll((Collection<? extends CommandConnection>)newValue);
				return;
			case SmarthomePackage.EVALUATING_NODE__FILTERS:
				getFilters().clear();
