...
public class SmarthomeFactoryImpl extends EFactoryImpl implements SmarthomeFactory {
    ...
    public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SmarthomePackage.COMMAND_CONNECTION: return createCommandConnection();
	 ...
	 * @generated
	 */
    public CommandConnection createCommandConnection() {
		CommandConnectionImpl commandConnection = new CommandConnectionImpl();
