 ...
 * </p>
 * <ul>
 *   <li>{@link com.incquerylabs.smarthome.model.simple.smarthome.impl.ContactItemImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.incquerylabs.smarthome.model.simple.smarthome.impl.ContactItemImpl#getStates <em>States</em>}</li>
 *   <li>{@link com.incquerylabs.smarthome.model.simple.smarthome.impl.ContactItemImpl#getAccaptedCommands <em>Accapted Commands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContactItemImpl extends MinimalEObjectImpl.Container implements ContactItem {
    ...
    public EList<State> getStates() {
		if (states == null) {
			states = new EObjectContainmentEList<State>(State.class, this, SmarthomePackage.CONTACT_ITEM__STATES);
		}
		return states;
	}
    ...
    public EList<Command> getAccaptedCommands() {
		if (accaptedCommands == null) {
			accaptedCommands = new EObjectContainmentEList<Command>(Command.class, this, SmarthomePackage.CONTACT_ITEM__ACCAPTED_COMMANDS);
		}
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SmarthomePackage.CONTACT_ITEM__ACCAPTED_COMMANDS:
