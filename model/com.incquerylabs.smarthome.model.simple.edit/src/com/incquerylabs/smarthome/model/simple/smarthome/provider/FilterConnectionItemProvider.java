...
/**
 * This is the item provider adapter for a {@link com.incquerylabs.smarthome.model.simple.smarthome.FilterConnection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FilterConnectionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FilterConnection_requiredState_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FilterConnection_requiredState_feature", "_UI_FilterConnection_type"),
				 SmarthomePackage.Literals.FILTER_CONNECTION__REQUIRED_STATE,
				 true,
				 false,
				 true,
				 null,
    ...
    protected void addItemPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FilterConnection_item_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FilterConnection_item_feature", "_UI_FilterConnection_type"),
				 SmarthomePackage.Literals.FILTER_CONNECTION__ITEM,
				 true,
				 false,
				 true,
				 null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SmarthomePackage.Literals.FILTER_CONNECTION__REQUIRED_STATE);
		}
    ...
    public String getText(Object object) {
		return getString("_UI_FilterConnection_type");
	}
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FilterConnection.class)) {
